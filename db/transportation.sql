...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2020 at 06:58 AM
...
(4, 'Quick Express', '|', 'Quick Express', 'Techno Park Bangladesh', 'http://www.technoparkbd.com/', 'public/uploads/admin_logo/logo1/logo_9656718870.png', NULL, NULL, 'public/uploads/admin_logo/logo2/piterk160500098_51354329914.png', NULL, NULL, 'public/uploads/admin_logo/fav_icon/piterk160500098_12460077396.png', NULL, NULL, 1, 4, '2020-07-07 04:10:02', 4, '2020-07-21 23:33:16');
...
CREATE TABLE `tbl_booking` (
  ...
  `seat_qty` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location_id` int(11) DEFAULT NULL,
  `puckup_location` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `drop_location` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `note` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `travel_status` int(11) DEFAULT 0,
  `status` tinyint(4) NOT NULL DEFAULT 1,
  `created_by` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL,
...
INSERT INTO `tbl_booking` (`id`, `client_id`, `order_no`, `date`, `travel_time`, `seat_qty`, `location_id`, `puckup_location`, `drop_location`, `note`, `travel_status`, `status`, `created_by`, `created_at`, `updated_by`, `updated_at`) VALUES
(26, NULL, 'co-200719-00001', '2020-07-19', '3pm', '3', 9, 'gulistan', 'kachua', NULL, 0, 0, NULL, '2020-07-19 02:12:22', NULL, '2020-07-19 02:12:22'),
(27, NULL, 'co-200719-00002', '2020-07-19', '3pm', '5', 9, 'gulistan', 'kachua', NULL, 0, 0, NULL, '2020-07-19 02:29:41', NULL, '2020-07-19 02:29:41'),
(28, 4, 'co-200719-00003', '2020-07-19', '7pm', '3', 8, 'gulistan dhaka', 'kachua ts road', 'sdfdsf', 1, 1, NULL, '2020-07-19 02:44:44', NULL, '2020-07-22 00:33:32'),
(29, 4, 'co-200720-00001', '2020-07-20', '3pm', '4', 9, 'Mirpur-10', 'kachua, Chandpur', NULL, 0, 0, NULL, '2020-07-19 23:22:36', NULL, '2020-07-19 23:22:36');
...
(53, '51', 'Booking List', 'bookingOrder.index', NULL, 2, '1', '2020-07-19 06:40:29', '2020-07-19 06:40:44');
...
(84, 53, 1, 'Add', 'bookingOrder.add', 1, 1, '2020-06-15 04:54:50', '2020-07-19 07:00:23'),
(85, 53, 2, 'Edit', 'bookingOrder.edit', 2, 1, '2020-06-15 04:54:58', '2020-06-15 04:54:58'),
(86, 53, 3, 'Status', 'bookingOrder.status', 4, 1, '2020-06-15 04:55:08', '2020-06-16 05:05:05'),
(87, 53, 4, 'Delete', 'bookingOrder.delete', 5, 1, '2020-06-15 04:55:23', '2020-06-16 05:04:58'),
(88, 53, 8, 'View', 'bookingOrder.view', 3, 1, '2020-06-16 05:05:33', '2020-06-16 05:05:33'),
...
(1, 'Transport System', '|', 'Transport System', 'https://technoparkbd.com/', 'Techno Park Bangladesh', 'https://technoparkbd.com/', '+880 1916 304 877', NULL, NULL, 'public/uploads/site_logo/logo1/logo_20069127196.png', 'public/uploads/site_logo/logo2/logo_25538897556.png', 'public/uploads/site_logo/fav_icon/piterk160500098_22874161032.png', 'meta title', NULL, 'meta description', 1, 4, '2020-04-17 08:33:15', NULL, '2020-07-21 23:25:29');
